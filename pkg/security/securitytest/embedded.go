...
func test_certsClientTestuserKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "test_certs/client.testuser.key", size: 1675, mode: os.FileMode(384), modTime: time.Unix(1400000000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func test_certsNodeCrt() (*asset, error) {
	...
	info := bindataFileInfo{name: "test_certs/node.crt", size: 1188, mode: os.FileMode(384), modTime: time.Unix(1400000000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
